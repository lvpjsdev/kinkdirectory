...
<template>
  <td
    class="text-center break-words py-2 px-0 sm:px-1 min-w-[40px] sm:min-w-[50px]" :class="[
  ...
  >
    <div class="flex justify-center items-center">
      ...
      <KinkChoice
        ...
        :on-click="onClick"
        :tooltip="tooltip"
        :kink-name="positionLabel ? `${kinkName} (${positionLabel})` : kinkName"
      />
      <div v-else class="w-4.5 h-4.5" />
    </div>
  </td>
</template>
