...
const subtleColorClasses = {
  ...
  1: 'border-green-200 dark:border-green-700 bg-green-100/30 dark:bg-green-900/20',
  2: 'border-lime-200 dark:border-lime-700 bg-lime-100/30 dark:bg-lime-900/20',
