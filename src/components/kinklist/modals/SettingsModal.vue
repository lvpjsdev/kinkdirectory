              ...
              <div class="p-2 border-t border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900">
                ...
                <div class="flex items-center space-x-2 p-1">
                  ...
                  <template v-if="settings.reverseKinkOrder">
                    ...
                    <div class="flex-shrink-0 w-4 h-4 rounded-full border-lime-500 dark:border-lime-400 bg-lime-500 dark:bg-lime-400" />
            ...
            <div class="rounded-lg border border-gray-200 dark:border-gray-700 overflow-hidden">
              ...
              <div class="p-2 border-t border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900">
                ...
                <div class="flex items-center space-x-2 p-1">
                  ...
                  <div class="flex-shrink-0 w-4 h-4 rounded-full border-lime-500 dark:border-lime-400 bg-lime-500 dark:bg-lime-400 flex items-center justify-center">
